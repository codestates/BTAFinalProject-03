                                    ...
                                    <TableBody>
                                        <TableRow>
                                            ...
                                            <TableCell>
                                                <Typography variant="caption" display="block" gutterBottom>
                                                    {
                                                        transactions.certificate.data.transactions[0].Call.package &&
                                                        transactions.certificate.data.transactions[0].Call.package.objectId
                                                    }
                                                </Typography>
                                            </TableCell>
                                        </TableRow>
                                        <TableRow>
                                            ...
                                            <TableCell>
                                                <Typography variant="caption" display="block" gutterBottom>
                                                    {
                                                        transactions.certificate.data.transactions[0].Call.module
                                                    }
                                                </Typography>
                                            </TableCell>
                                        </TableRow>
                                        ...
                                        <TableRow>
                                            ...
                                            </TableCell>
                                            {
                                                ...
                                                <TableCell>
                                                    <Typography variant="caption" display="block" gutterBottom>
                                                        <Link
                                                            to={'/get-obj/' + transactions.certificate.data.gasPayment.objectId}
                                                ...
                                                <Typography variant="caption" display="block" gutterBottom>
                                                    {
                                                        (transactions &&
                                                            ...
                                                            financial(Math.abs(transactions.effects.events[0].coinBalanceChange.amount) * 0.000000001))
                                                    } SUI
                                                </Typography>
                                            </TableCell>
                                        </TableRow>
