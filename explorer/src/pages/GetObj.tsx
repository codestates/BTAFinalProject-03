...
const GetObj = () => {
    ...
    return (
        <>
            ...
            <Div>
                <Typography variant="subtitle1" gutterBottom><DataObjectOutlinedIcon
                    sx={{width: 15, height: 15}}/> Object</Typography>
                ...
                <Box bgcolor="info" p={2}>
                    <Typography variant="subtitle2" display="block" gutterBottom>Description</Typography>
                    <TableContainer>
                    ...
                    <br/><Typography variant="subtitle2" display="block" gutterBottom>Properties</Typography>
                    <TableContainer>
                        <Table sx={{width: 1000}} aria-label="simple table">
                            <TableBody>
                                {
