...
__export(src_exports, {
  ...
  isCoinDenominationInfoResponse: () => isCoinDenominationInfoResponse,
  ...
  shouldUseOldSharedObjectAPI: () => shouldUseOldSharedObjectAPI
});
...
var bcs = new import_bcs6.BCS((0, import_bcs6.getSuiMoveConfig)());
bcs.registerType(
  "utf8string",
  (writer, str) => {
  ...
  "ObjectDigest",
  (writer, str) => {
    let bytes = Array.from((0, import_bcs6.decodeStr)(str, "base64"));
    return writer.writeVec(bytes, (writer2, el) => writer2.write8(el));
  },
  (reader) => {
    let bytes = reader.readVec((reader2) => reader2.read8());
    return (0, import_bcs6.encodeStr)(new Uint8Array(bytes), "base64");
  }
);
...
var HexDataBuffer = class {
  constructor(data) {
    if (typeof data === "string") {
      this._data = (0, import_bcs7.fromHEX)(data);
    } else {
      this._data = data;
    }
  }
  ...
  toString() {
    return (0, import_bcs7.toHEX)(this._data);
  }
};
